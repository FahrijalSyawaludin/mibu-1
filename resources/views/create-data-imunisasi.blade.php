                                ...
                                <div class="container-fluid">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <form action="{{ route('data-imunisasi.store') }}" method="post">
                                                @csrf
                                                ...
                                                <div class="form-group mt-5">
                                                    ...
                                                    <input type="text" name="nama_pemeriksa" id="nama_pemeriksa" class="form-control @error('nama_pemeriksa') is-invalid @enderror"
