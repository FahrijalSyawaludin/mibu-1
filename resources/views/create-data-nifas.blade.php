                        ...
                        <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
                            <div
                                ...
                                <div class="d-flex align-items-center flex-wrap mr-2">
                                    <!--begin::Page Title-->
                                    <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Data Nifas</h5>
                                    <!--end::Page Title-->
                                </div>
                                <!--end::Info-->
                                <!--begin::Toolbar-->
                                <div class="d-flex align-items-center">
                                    ...
                                    <ul
                                        ...
                                        <li class="breadcrumb-item text-muted">
                                            <a href="{{ route('data-nifas.index') }}" class="text-muted">Data Nifas</a>
                                        </li>
                                        <li class="breadcrumb-item text-muted">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form action="{{ route('data-nifas.store') }}" method="post">
                                                ...
                                                <div class="form-group mt-5">
                                                    ...
                                                    <select name="id_ibu" id="id_ibu" class="form-control @error('id_ibu') is-invalid @enderror">
                                                        ...
                                                        @foreach($data_ibu_hamils as $ibu)
                                                            <option value="{{ $ibu->id }}">{{ $ibu->nama_ibu }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('id_ibu')
                                                        <span class="invalid-feedback" role="alert">
                                                ...
                                                <div class="form-group mt-5">
                                                    ...
                                                    <input type="text" name="kunjungan_nifas" id="kunjungan_nifas" class="form-control @error('kunjungan_nifas') is-invalid @enderror"
                                                ...
                                                <div class="form-group mt-5">
                                                    ...
                                                    <input type="text" name="hasil_periksa_payudara" id="hasil_periksa_payudara" class="form-control @error('hasil_periksa_payudara') is-invalid @enderror"
                                                ...
                                                <div class="form-group mt-5">
                                                    ...
                                                    <input type="text" name="hasil_periksa_pendarahan" id="hasil_periksa_pendarahan" class="form-control @error('hasil_periksa_pendarahan') is-invalid @enderror"
                                                ...
                                                <div class="form-group mt-5">
                                                    ...
                                                    <input type="text" name="hasil_periksa_jalan_lahir" id="hasil_periksa_jalan_lahir" class="form-control @error('hasil_periksa_jalan_lahir') is-invalid @enderror"
                                                ...
                                                <div class="form-group mt-5">
                                                    ...
                                                    <input type="text" name="vitamin_a" id="vitamin_a" class="form-control @error('vitamin_a') is-invalid @enderror"
                                                ...
                                                <div class="form-group mt-5">
                                                    ...
                                                    <input type="text" name="masalah" id="masalah" class="form-control @error('masalah') is-invalid @enderror"
                                                ...
                                                <div class="text-right">
                                                    <a href="{{ route('data-nifas.index') }}" class="btn btn-outline-danger mr-2"
                                                        role="button">Batal</a>
