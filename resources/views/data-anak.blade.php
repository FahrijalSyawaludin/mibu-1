                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <ul
                                        ...
                                        <li class="breadcrumb-item text-muted">
                                            <a href="" class="text-muted">Data Anak</a>
                                        </li>
                                    </ul>
                                    <!--end::Breadcrumb-->
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-5 text-right">
                                                <a href="{{ route('data-anak.create') }}" type="button" class="btn btn-success"><i
                                                        class="flaticon2-add-1"></i><strong>Data Baru</strong>
                                                </a>
                                                <a href="{{ route('data-anak.download') }}" type="button" class="btn btn-primary ml-2">
                                        ...
                                        <div class="row table-responsive">
                                            <table class="table text-center">
                                                ...
                                                <tbody>
                                                    @php
                                                         $num = ($data_anaks->currentPage() - 1) * $data_anaks->perPage() + 1;
                                                    @endphp
                                                    @forelse ($data_anaks as $da)
                                                        <tr>
                                                            <td>{{ $num++ }}</td>
                                                            <td>{{ $da->tanggal }}</td>
                                                            <td>{{ $da->ibuHamil->nama_ibu ?? 'Nama Tidak Ditemukan' }}</td>
                                                            <td>{{ $da->nama_anak }}</td>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a data-toggle="modal" data-target="#deleteModal-{{ $da->id }}"><i class="flaticon2-trash mr-3"></i></a>
                                                                
                                                                <!-- Delete Modal -->
                                                                <div class="modal fade" id="deleteModal-{{ $da->id }}" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel"
                                                                aria-hidden="true">
                                                                    <div class="modal-dialog" role="document">
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-footer">
                                                                                ...
                                                                                <form id="deleteForm-{{ $da->id }}" action="{{ route('data-anak.delete', $da->id) }}" method="POST">
                                                                                    @csrf
                                                                                    @method('DELETE')
                                            ...
                                            <div class="d-flex justify-content-between align-items-center flex-wrap">
                                                <div class="d-flex align-items-center py-3">
                                                    ...
                                                    <form method="GET" action="data-anak.index">
                                                        <select id="entries"
        ...
        <script>
            $(document).ready(function() {
                $(document).on('change', '#entries', function() {
                    window.location =
                        "{{ route('data-anak.index') }}?search={{ request('search') }}&per_page=" + $(this)
                        .val();
                });
            });
        </script>
