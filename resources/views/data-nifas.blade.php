                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <ul
                                        ...
                                        <li class="breadcrumb-item text-muted">
                                            <a href="" class="text-muted">Data Nifas</a>
                                        </li>
                                    </ul>
                                    <!--end::Breadcrumb-->
                                </div>
                            ...
                            <div class="container">
                                <div class="card card-custom">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-4">
                                                <form action="{{ route('data-nifas.index') }}" method="GET">
                                            ...
                                            <div class="col-5 text-right">
                                                <a href="{{ route('data-nifas.create') }}" type="button" class="btn btn-success"><i
                                                        class="flaticon2-add-1"></i><strong>Data Baru</strong>
                                                </a>
                                                <a href="{{ route('data-nifas.download') }}" type="button" class="btn btn-primary ml-2">
                                        ...
                                        <div class="row table-responsive">
                                            <table class="table text-center">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>Nama Ibu</th>
                                                        <th>Kunjungan Nifas Ke</th>
                                                        <th>Hasil Periksa Payudara (ASI)</th>
                                                        <th>Hasil Periksa Pendarahan</th>
                                                        <th>Hasil Periksa Jalan Lahir</th>
                                                        <th>Vitamin A</th>
                                                        <th>Masalah</th>
                                                        <th>Tindakan</th>
                                                        <th>Aksi</th>
                                                ...
                                                <tbody>
                                                    @php
                                                         $num = ($data_nifas->currentPage() - 1) * $data_nifas->perPage() + 1;
                                                    @endphp
                                                    @forelse ($data_nifas as $dn)
                                                        <tr>
                                                            <td>{{ $num++ }}</td>
                                                            <td>{{ $dn->tanggal }}</td>
                                                            ...
                                                            <td>{{ $dn->hasil_periksa_jalan_lahir }}</td>
                                                            <td>{{ $dn->vitamin_a }}</td>
                                                            <td>{{ $dn->masalah }}</td>
                                                            <td>{{ $dn->tindakan }}</td>
                                                            <td>
                                                                <!-- Action buttons -->
                                                                <a href="{{ route('data-nifas.edit', $dn->id) }}"><i class="flaticon2-edit mr-3"></i></a>
                                                                <a data-toggle="modal" data-target="#deleteModal-{{ $dn->id }}"><i class="flaticon2-trash mr-3"></i></a>
                                                                
                                                                <!-- Delete Modal -->
                                                                <div class="modal fade" id="deleteModal-{{ $dn->id }}" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel"
                                                                aria-hidden="true">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center flex-wrap">
                                                <div class="d-flex align-items-center py-3">
                                                    ...
                                                    <form method="GET" action="{{ route('data-nifas.index') }}">
                                                        <select id="entries"
        ...
        <script>
            $(document).ready(function() {
                $(document).on('change', '#entries', function() {
                    window.location =
                        "{{ route('data-nifas.index') }}?search={{ request('search') }}&per_page=" + $(this)
                        .val();
                });
            });
        </script>
